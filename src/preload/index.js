...
const api = {
    ...
    onMessageDelta: (callback) => subscribe(IPC_CHANNELS.onMessageDelta, callback),
    onToolStarted: (callback) => subscribe(IPC_CHANNELS.onToolStarted, callback),
    onAskUserRequest: (callback) => subscribe(IPC_CHANNELS.onAskUserRequest, callback),
    respondAskUser: (payload) => ipcRenderer.invoke(IPC_CHANNELS.respondAskUser, payload),
